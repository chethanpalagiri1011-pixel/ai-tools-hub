    ...
    try:
        ...
        recent_users = [
            {
                ...
                "credits": u.credits,
                "created_at": format_dt(u.created_at)
            }
        ...
        for act in recent_activity_db:
            ...
            recent_activity.append({
                ...
                "created_at": format_dt(act.created_at)
            })
            ...
            recent_feedback = [
                {
                    ...
                    "rating": fb.rating,
                    "comment": fb.comment,
                    "created_at": format_dt(fb.created_at)
                }
        ...
        print("Admin stats error:", err)
        db.rollback()
        return {
            "total_users": db.query(User).count() if db else 1,
            "total_generations": 0,
            "breakdown": {"image": 0, "summary": 0, "caption": 0, "prompt": 0},
            "recent_users": [],
            "recent_activity": [],
            "recent_feedback": []
        }
