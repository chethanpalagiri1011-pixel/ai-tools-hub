...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-400 flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-64 h-64 rounded-full opacity-15 blur-3xl pointer-events-none"
      ...
      <div className="relative w-full max-w-md animate-fade-in-up">
        ...
        <div className="p-8 rounded-2xl border border-white/10"
          ...
          <p className="text-gray-400 text-sm mb-6">Sign in to your AI Tools Hub account</p>

          {/* Quick Demo Fill Button */}
          <button 
            type="button"
            onClick={fillDemo}
            className="w-full py-2 rounded-xl text-xs font-semibold transition-all border border-dashed border-purple-500/40 text-purple-300 hover:bg-purple-500/10 mb-6 flex items-center justify-center gap-2 cursor-pointer"
          >
            <span>✨ Fill Owner Demo Credentials</span>
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full flex items-center justify-center gap-2 py-3.5 mt-2 cursor-pointer disabled:opacity-50"
            >
              {loading ? (
                <>
